        ...
        <Row>
          <Col>
            <div className="game-divs">
              ...
              <p className="tweet tweet-text" tabIndex={0}>
            ...
            <Form>
              <Form.Group>
                ...
                <Form.Control
                  as="textarea"
                  rows={4}
                  className="game-divs tweet-text"
                  onKeyDown={e => {
                    const key = e.key;
                    if (key === "Escape") {
                      resetTyping();
                  ...
                  onChange={() => {
                    ...
                    console.log(
                      "WPM = " +
                        Math.round((wordsTyped * 60000) / getDuration())
                    );
                    console.log("\n");
